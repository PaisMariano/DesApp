...
public class ProjectController {
    ...
    @PutMapping("/projects/{id}/suspend")
    public ResponseEntity<String> suspendProject(
            @PathVariable("id") Integer projectId) throws Exception {

        projectService.updateProjectService(projectId, 3);
        return ResponseEntity.status(HttpStatus.OK).body("Resource updated successfully");
    }
